...
from algorithm.bidmatch import get_algorithm, name2alg
...
def get_config():
    from algorithm.bidmatch import str2bool
    ...
    parser.add_argument("-bsz", "--batch_size", type=int, default=512)
    parser.add_argument(
        "--uratio",
        type=int,
        default=7,
...
if __name__ == "__main__":
    args = get_config()
    port = get_port()
    args.dist_url = "http://localhost:" + str(port)
    main(args)
