...
from algorithm.datasets.augmentation import RandAugment
from algorithm.datasets.utils import get_onehot
    ...
    def __getitem__(self, idx):
        ...
        if self.transform is None:
            ...
            if not self.is_ulb:
                ...
                elif self.alg == 'flexmatch' and self.strong_transform is not None:
                    return {'idx_lb': idx, 'x_lb': self.strong_transform(img), 'y_lb': target}
                else:
